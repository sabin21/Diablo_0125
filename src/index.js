...
let video, videoTexture, videoMat, phoneBodyMat, iconRig, trailerScreenMat, trailerTexture, trailerVideo, trailerMat, groundMirror;
...
function animation() {
	//camera.position.lerp(new THREE.Vector3(mouseX*0.002, 0, 5), 0.002);
	camera.lookAt( 0,0,0 );
    render();	
};
